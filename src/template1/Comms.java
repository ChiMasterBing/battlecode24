...
//            System.out.println(bufferPool[13]);
    ...
    private static void getFlagLocs() {
        MapLocation[] spawnLocs = {new MapLocation(-1, -1), new MapLocation(-1, -1), new MapLocation(-1, -1)};
        spawnLocs[0] = rc.getAllySpawnLocations()[0].add(Direction.NORTHEAST);
