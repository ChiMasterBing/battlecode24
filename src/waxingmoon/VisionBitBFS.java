...
public class VisionBitBFS {
    ...
    public VisionBitBFS(MapLocation myLoc, MapInfo[] mapInfos) {
        // ~1460 bytecode
        center = myLoc;
        ...
        tempMask[0] ^= 0x1ff; //0b001111100
        tempMask[1] ^= 0x1ff; //0b011111110
        tempMask[2] ^= 0x1ff;
        tempMask[3] ^= 0x1ff;
        tempMask[4] ^= 0x1ff;
        tempMask[5] ^= 0x1ff;
    ...
    public int[][] bfs(MapLocation origin, int maxIters) {
        ...
        while (idx++ < maxIters && (turn0 != 0 || turn1 != 0 || turn2 != 0 || turn3 != 0 || turn4 != 0 || turn5 != 0 || turn6 != 0 || turn7 != 0 || turn8 != 0)) {
            ...
            temp0 = (turn0 << 1) | (turn0 >> 1) | (turn1 << 1) | turn1 | (turn1 >> 1);
            temp1 = (turn0 << 1) | turn0 | (turn0 >> 1) | (turn1 << 1) | (turn1 >> 1) | (turn2 << 1) | turn2 | (turn2 >> 1);
            temp2 = (turn1 << 1) | turn1 | (turn1 >> 1) | (turn2 << 1) | (turn2 >> 1) | (turn3 << 1) | turn3 | (turn3 >> 1);
            temp3 = (turn2 << 1) | turn2 | (turn2 >> 1) | (turn3 << 1) | (turn3 >> 1) | (turn4 << 1) | turn4 | (turn4 >> 1);
            temp4 = (turn3 << 1) | turn3 | (turn3 >> 1) | (turn4 << 1) | (turn4 >> 1) | (turn5 << 1) | turn5 | (turn5 >> 1);
            temp5 = (turn4 << 1) | turn4 | (turn4 >> 1) | (turn5 << 1) | (turn5 >> 1) | (turn6 << 1) | turn6 | (turn6 >> 1);
            temp6 = (turn5 << 1) | turn5 | (turn5 >> 1) | (turn6 << 1) | (turn6 >> 1) | (turn7 << 1) | turn7 | (turn7 >> 1);
            temp7 = (turn6 << 1) | turn6 | (turn6 >> 1) | (turn7 << 1) | (turn7 >> 1) | (turn8 << 1) | turn8 | (turn8 >> 1);
            temp8 = (turn7 << 1) | turn7 | (turn7 >> 1) | (turn8 << 1) | (turn8 >> 1);
    ...
    public int[] floodfill(int iters) {
        return floodfill(center, iters);
    }
