...
//        if(stunTraps==0||explosiveTraps>2||rc.senseNearbyRobots(trapLocation, 8, rc.getTeam().opponent()).length<Math.max(8-rc.getCrumbs()/500, 1)){
//            return;
//        }
...
//        return false;
//    }
//    public void goToEmpty() throws GameActionException {
//        int avgx = 0;
//        int avgy = 0;
//        int tot = 0;
//        for(MapInfo i: nearbyInfo){
//            MapLocation tmp = i.getMapLocation();
//            if(tmp.x%3==1&&tmp.y%3==1){
//                if(i.getTrapType()==TrapType.NONE){
//                    avgx+=tmp.x;
//                    tot++;
//                    avgy+=tmp.y;
//                }
...
//            return;
//        }
//        BFSController.move(rc, new MapLocation(avgx/tot, avgy/tot));
//    }
...
//                    return;
//            }
//            if(closeFriendlyRobots.length>0) {
//                goToEmpty();
//            }
...
//        updateCurrentTarget();
//        if(rc.getRoundNum()>200&&friendlyRobots.length>3) {
